...
import com.example.soullive.databinding.FragmentVerifyResult4Binding
import com.example.soullive.home.KeywordAdapter
import com.example.soullive.home.ModelResult

class VerifyResult4Fragment : Fragment(), VerifyResultModelAdapter.ModelItemClickListener {
    lateinit var binding: FragmentVerifyResult4Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentVerifyResult4Binding.inflate(inflater, container, false)
        ...
        // 검증 완료-전략 적합도 페이지로 이동
        binding.modelImg.setOnClickListener {
            val intent = Intent(context, VerifyResultDetailActivity4::class.java)
