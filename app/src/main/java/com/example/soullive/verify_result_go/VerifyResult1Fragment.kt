...
import com.example.soullive.databinding.FragmentVerifyResult1Binding
import com.example.soullive.home.KeywordAdapter
import com.example.soullive.home.ModelResult

class VerifyResult1Fragment : Fragment(), VerifyResultModelAdapter.ModelItemClickListener {
    lateinit var binding: FragmentVerifyResult1Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentVerifyResult1Binding.inflate(inflater, container, false)
