...
import com.example.soullive.databinding.ActivityVerifyResultDetail5Binding
import com.example.soullive.home.KeywordAdapter

class VerifyResultDetailActivity5 : AppCompatActivity() {
    lateinit var binding: ActivityVerifyResultDetail5Binding
    lateinit var keywordAdapter: KeywordAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityVerifyResultDetail5Binding.inflate(layoutInflater)
