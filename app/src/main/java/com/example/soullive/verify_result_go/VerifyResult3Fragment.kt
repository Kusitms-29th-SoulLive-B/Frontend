...
import com.example.soullive.databinding.FragmentVerifyResult3Binding
import com.example.soullive.home.KeywordAdapter
import com.example.soullive.home.ModelResult

class VerifyResult3Fragment : Fragment(), VerifyResultModelAdapter.ModelItemClickListener {
    lateinit var binding: FragmentVerifyResult3Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentVerifyResult3Binding.inflate(inflater, container, false)
        ...
        binding.modelImg.setOnClickListener {
            val intent = Intent(context, VerifyResultDetailActivity3::class.java)
