...
import com.example.soullive.databinding.FragmentVerifyResultBinding
import com.example.soullive.home.KeywordAdapter
import com.example.soullive.home.ModelResult
import com.example.soullive.verify_result_go.VerifyResultModelAdapter

class VerifyResultFragment : Fragment(), VerifyResultModelAdapter.ModelItemClickListener {
    lateinit var binding: FragmentVerifyResultBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentVerifyResultBinding.inflate(inflater, container, false)
        ...
        val keywords = listOf("업계 1위 유튜버", "신뢰있는", "유머스러운")
        keywordAdapter.updateData(keywords)

        // 검증 완료-종합 페이지로 이동
        binding.modelImg.setOnClickListener {
            val intent = Intent(context, VerifyResultDetailActivity5::class.java)
